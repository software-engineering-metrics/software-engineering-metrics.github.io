...
is added to any team or organisational dashboard, because it is the fastest
...
signals the whole organisation owns together, connected through an explicit
...
5. **How much of what we celebrate in reviews and retrospectives is output
   ...
   language teams use to celebrate work shapes what they optimise for over
...
optimising local output metrics that do not sum to any coherent
organisational outcome. Build the metric tree deliberately, standardise
...
records modernisation programme. An oversight committee asked a different
...
The return on outcome weighting is avoided waste: an organisation that can
...
the hard way. The dominant hidden cost in large engineering organisations is
...
- **Treating outcome measurement as too hard to attempt:** defaults an
  organisation permanently back to easy-to-count inputs and outputs.

## Maturity model

- **Level 1, Initiate:** Metrics are almost entirely inputs and outputs;
  no one can name the organisation's outcome metrics or trace a line to
  them.
- **Level 2, Develop:** Some teams have identified outcome metrics
  ...
  indicators.
- **Level 3, Standardise:** A documented metric tree connects a shared
...
- **Level 5, Orchestrate:** Outcome measurement is integrated into funding
  and prioritisation decisions directly; the organisation routinely redirects
  investment away from high-output, low-outcome work before a full budget
  cycle elapses.

## Ideas for discussion

1. Name our organisation's single most important outcome metric. Can everyone agree on it?
...
- Hold teams accountable for what they **control** (inputs, outputs); track
  outcomes as shared signals the whole organisation influences together.

...
2. **Which of our metrics rely on self-report for something a system could
   ...
   reliably. Identify these and prioritise replacing the highest-stakes ones.

3. **How would we know if one of our data pipelines silently broke?** Most
   organisations discover a broken metrics pipeline only when someone
...
migrations, and business-unit boundaries. Invest in centralised,
...
- **Level 3, Standardise:** Every governed metric documents its source
...
- **Level 5, Orchestrate:** The organisation treats data quality as a
...
- Instrument **at the event**, not downstream of a translation, to minimise

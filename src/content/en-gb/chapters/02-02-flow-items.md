...
most organisations have no consistent, honest way to see the actual split.
...
deliberately with business stakeholders. Enterprise organisations running
...
4. **What would a healthy flow distribution look like for our product's
   ...
   stakeholders?** Most organisations have never made this target explicit,
...
debt and risk work are not silently deprioritised every time a feature
...
value at scale, because a large organisation running many concurrent value
...
corroborated the debt burden, secured a dedicated modernisation budget the
...
deprioritised in favour of visible citizen-facing features, had shrunk to
...
example above, securing a modernisation budget with actual capacity data
...
- **Level 2, Develop:** Some teams classify flow items informally, but
  ...
  retroactively.
- **Level 3, Standardise:** All teams classify at intake against a shared,
...
- **Level 5, Orchestrate:** Flow-item data directly informs resourcing and
  investment decisions across the organisation, and leadership can point to

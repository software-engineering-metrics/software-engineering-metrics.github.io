...
- **Starting new work feels like progress; finishing work is what actually
  delivers value.** These are not the same thing, and organisations
  routinely confuse them.
- **High WIP is often invisible until measured.** A team can be juggling far
  more concurrent work than anyone individually realises.
...
formalised in kanban, is one of the most consistently effective flow
...
3. **If we adopted a WIP limit, what would need to change about how we
   ...
   organisational habit, starting new work reflexively, that a WIP limit is
...
concurrent initiatives than they realise, which is worth measuring even
...
organisation-wide visibility into the total. Introducing portfolio-level WIP
...
when an organisation does less at once, because less context switching and
...
reducing concurrent work, is a common pattern once organisations actually
measure and act on flow efficiency rather than assuming more parallel work
always means more progress.

The total cost of adopting this discipline is mostly organisational, not
...
- **Measuring WIP only at the team level, missing portfolio-level
  overload:** common in large organisations running many concurrent
...
- **Level 3, Standardise:** Teams have explicit, visible WIP limits at the
...
- **Level 5, Orchestrate:** WIP is visible and managed at the portfolio
  level, not just the team level, and the organisation can point to specific
...
5. Where in our organisation is portfolio-level WIP invisible and probably too high?

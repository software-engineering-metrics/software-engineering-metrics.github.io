...
time, utilisation, descends from a much older toolkit: the five baseline
measurements of classical **[Lean](https://en.wikipedia.org/wiki/Lean_manufacturing)**
value stream mapping, developed at Toyota and generalised across
...
invisibly across handoffs, a pattern enterprise organisations with long,
...
- **These five metrics predate software and generalise beyond it.** They
...
- **Takt time reframes capacity planning around demand, not effort.** The
  ...
  which connects directly to utilisation (chapter 2.7) and flow load
  (chapter 2.4).
...
Where your organisation already runs a Lean Six Sigma programme outside
...
4. **If a Lean Six Sigma-trained stakeholder from outside engineering asked
   ...
   caused a real misunderstanding in your organisation.
...
6. **Is our organisation already running a Lean or Six Sigma programme
...
used software-specific language the office did not recognise. After
...
elsewhere in a large organisation. The manufacturing company example
...
- **Ignoring an existing Lean Six Sigma programme elsewhere in the
  organisation:** forfeits funding, expertise, and institutional credibility
...
- **Level 3, Standardise:** All five classical metrics are computed
...
- **Level 5, Orchestrate:** The organisation has connected its software
...
3. Does our organisation already run a Lean or Six Sigma programme we have never connected engineering metrics to?
...
- **Takt time reframes capacity around real customer demand**, not
  existing pace, and pairs directly with utilisation (chapter 2.7) and
...
- Reframing software delivery in classical Lean terms is often the fastest
  ...
  funding** already present in a large organisation.

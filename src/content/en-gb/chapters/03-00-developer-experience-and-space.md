...
interruptions, or quietly disengaging. An organisation that only watches
...
is this delivery performance sustainable, and is the organisation retaining
the people who produce it. Enterprise organisations that ignore this part
tend to discover the cost through attrition data and exit interviews, well
after the damage is done; government organisations, often operating under
...
- **3.1 The SPACE framework:** The five dimensions together, why no single
  ...
  from them.
- **3.2 Satisfaction and well-being metrics:** Measuring fulfilment,

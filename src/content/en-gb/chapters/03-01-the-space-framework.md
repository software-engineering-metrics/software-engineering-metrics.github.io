...
measure, almost always activity. Enterprise organisations comparing
productivity across many teams need a framework that resists the pull toward
counting commits; government organisations facing recruitment and retention
...
the framework as a lens for understanding team and organisational
...
1. **Does our current productivity metric set draw from at least three
   ...
   organisations, honestly assessed, are far more activity-heavy than they
   realise.
...
Standardise a balanced SPACE metric set across teams so leadership can
...
- **Level 3, Standardise:** A balanced metric set drawing from at least
...
- **Level 5, Orchestrate:** SPACE data directly shapes workforce planning
  and retention investment, and the organisation can point to specific

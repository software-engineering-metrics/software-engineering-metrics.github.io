...
An organisation that only watches delivery and activity metrics finds out
...
their team. Enterprise and government organisations, with their formal
...
- **Burnout is a specific, recognisable pattern, not just generic
...
which measures burnout across three recognised dimensions: emotional
exhaustion, depersonalisation or cynicism, and reduced sense of personal
...
otherwise be inferred. Use a third-party survey tool that the organisation
itself cannot de-anonymise, publish aggregate results only above a minimum
...
large-headcount organisation before it drives attrition protects a much
...
warning: an organisation that catches a burnout trend a full year before it
...
experienced engineer costs an organisation far more than the survey
infrastructure that could have provided the warning.

The total cost of ownership includes survey tooling, the discipline of
guaranteeing and maintaining genuine anonymity, and the organisational
...
- **Level 3, Standardise:** A validated or adapted survey instrument runs on
...
- **Level 4, Manage:** Trends are actively tracked over successive cycles,
  ...
  the organisation has a documented process for acting on warning signs.
- **Level 5, Orchestrate:** Well-being data directly informs workforce
  ...
  signals, and the organisation can point to specific interventions that
...
- *The Burnout Challenge: Managing People to Avoid Burnout and Improve
  Wellbeing*, by Christina Maslach and Michael P. Leiter (organisational

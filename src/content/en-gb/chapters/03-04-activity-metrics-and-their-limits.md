...
evidence to resist it, because once an organisation starts individually
...
moment activity becomes an incentivised individual metric, gaming follows
...
events, actively harms the organisation.
...
data entirely but by building a hard organisational rule against individual
use, while permitting and even encouraging thoughtful, contextualised
team-level use.

## Questions to discuss with your team

1. **Has anyone in our organisation ever been evaluated, formally or
...
2. **What would activity theater look like on our team specifically, and
   ...
   pattern could take on your own team makes it far easier to recognise if
   it starts happening.
...
6. **What does genuinely valuable but quiet work, deep thinking, careful
   ...
   recognised despite generating little visible activity data?** This
...
rather than as individual scorecards, is avoided damage: organisations that
...
The total cost of avoiding this trap is mostly organisational discipline: an
...
- **Level 3, Standardise:** An explicit, communicated organisation-wide
...
- **Level 4, Manage:** Performance-review and promotion practices are
  ...
  is used at all.
- **Level 5, Orchestrate:** The organisation has demonstrably shifted

...
a five-hundred-person organisation spread across time zones and business
...
- **Onboarding speed is a direct, measurable proxy for how well shared
  understanding actually flows** in an organisation.
...
understanding actually flows in an organisation: a team where knowledge
...
An organisational chart describes who is supposed to report to whom; it
...
organisations skip it, even though its failures are frequently the hidden
...
Prioritise documenting the two or three most fragile, most concentrated
...
public-sector organisations can create severe bus-factor risk hiding behind
...
starkest version of this return: an organisation that discovers and fixes a
...
- **Level 2, Develop:** Some informal awareness of knowledge concentration
  ...
  investigation.
- **Level 3, Standardise:** Bus factor and cross-team dependency friction
...
- **Level 5, Orchestrate:** The organisation proactively reduces

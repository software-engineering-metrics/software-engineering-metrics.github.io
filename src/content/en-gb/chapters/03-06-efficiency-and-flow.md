...
organisations, with their heavier governance and coordination needs, are
...
about whether the organisation's coordination overhead has grown beyond
what protects genuine focus.

### Protect explicit focus-time blocks as a team or organisational norm
...
by default. This requires organisational buy-in beyond a single team's
...
| Organisation-wide meeting-free periods | Strongest protection, hardest to erode | Requires broad organisational commitment and can feel rigid for roles needing more coordination |
...
organisations genuinely need meetings and cross-team coordination to
...
6. **If we protected two full afternoons a week for deep work
   organisation-wide, what would we have to say no to, and would it be worth
...
organisation, and treat protected focus blocks as an organisation-wide
...
public-sector organisations make this dimension especially important to
...
instituted two mandatory, organisation-wide meeting-free afternoons per
...
in genuine focus-time availability can produce an outsised improvement in
the organisation's capacity for its hardest, highest-value work.

The total cost of ownership is almost entirely organisational discipline
...
- **Level 2, Develop:** Some awareness of fragmentation exists informally,
  but no calendar data is analysed and no protected time is formally
  established.
- **Level 3, Standardise:** Focus-time availability is measured from
  calendar data, and protected, meeting-free blocks are established as a
  team or organisational norm.
...
- **Level 5, Orchestrate:** The organisation treats focus-time protection as

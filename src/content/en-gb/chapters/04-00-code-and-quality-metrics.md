...
prioritised remediation rather than an ever-growing, unloved backlog.
...
system are fragile; a five-hundred-engineer organisation spanning dozens of
services needs instrumented signals to find that fragility systematically.
Enterprise and government organisations, often carrying codebases measured
in decades rather than years, depend on this part's metrics to prioritise
...
- **4.5 Technical debt measurement:** Making an invisible, informally
  discussed liability into a visible, prioritised, manageable portfolio.
...
a managed, prioritised backlog rather than a diffuse, unaddressed worry; and
...
failure rate (chapter 2.10) is, in large part, a downstream consequence of

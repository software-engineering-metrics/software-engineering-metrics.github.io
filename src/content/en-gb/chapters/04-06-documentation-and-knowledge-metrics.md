...
For large teams, this chapter's concerns compound with organisational
...
the organisation discovers the knowledge was never actually captured
anywhere durable. Enterprise and government organisations, with typically
...
them to prioritise reorganising or better surfacing existing content over
writing more of it.
...
### Identify and prioritise undocumented critical-knowledge areas
explicitly
...
systems, so documentation work competes fairly for prioritised capacity
...
2. **What question gets asked repeatedly in our team chat despite a
   ...
   reorganising or better surfacing existing content rather than writing
   more.
...
5. **Does our technical debt backlog (chapter 4.5) include documentation
   ...
   prioritised capacity or effectively invisible.
...
**Small business.** Prioritise documenting your single most critical,
...
badly here, since a large organisation accumulates documentation across
many teams and platforms faster than anyone can keep it current or
consistently organised. Invest in documentation-platform analytics to track
access and staleness at scale, and treat documentation debt as a first-class
category in your organisation-wide debt backlog.

**Government.** Long employee tenure common in public-sector organisations
...
unrelated reorganisation, that its core risk-calculation engine had no
...
prioritised proactively rather than discovered as an emergency.
...
answered somewhere in the agency's sprawling, poorly organised
documentation platform. Rather than writing more content, the agency
invested in reorganising and improving the search and navigation structure
...
into a prioritised backlog rather than treating them as perpetually
...
- **Treating documentation debt as perpetually lower-status than code
  debt:** leaves it chronically deprioritised and invisible on the backlog.
...
- **Level 3, Standardise:** Access and staleness are tracked for critical
  systems, and onboarding time is measured as a proxy for knowledge health
  organisation-wide.
- **Level 4, Manage:** Documentation gaps are folded into the prioritised
  technical debt backlog, cross-referenced with bus-factor risk to identify
  the most severe combined risks.
- **Level 5, Orchestrate:** The organisation proactively identifies and
...
- Fold **documentation gaps into your technical debt backlog** (chapter
  4.5) so they compete fairly for prioritised capacity.
...
- *Team Topologies*, by Matthew Skelton and Manuel Pais (organisational

...
the full range of customer and business outcomes an organisation actually
cares about: revenue retained or grown, customer satisfaction and loyalty,
cost reduction, risk avoided, and, for public-sector organisations, the
...
organisation's contribution to the business.
...
of direct causation. A well-run engineering organisation can show that its
...
value is assumed rather than demonstrated. Enterprise organisations use
...
organisations use the equivalent citizen-outcome metrics to demonstrate that
...
- **Government and mission-driven organisations have outcome metrics beyond
...
For government and nonprofit organisations, the equivalent of "revenue" is
...
private-sector organisations apply to revenue metrics, and resist the
...
| Approach | Pros | Cons |
| --- | --- | --- |
| Claiming direct causation from engineering metrics to business outcomes | Simple, compelling narrative | Usually overstates certainty; vulnerable to being debunked by a sceptical audience |
...
| Combined quantitative and qualitative outcome evidence | Richer, more explanatory, catches what numbers alone miss | Requires more effort to gather and synthesise both types of evidence |
...
be wrong and, if challenged by a sceptical stakeholder, to damage the
engineering organisation's credibility for future claims. Resolve the
...
2. **What confounding factors did we consider, and rule out, before making
   ...
   a gap worth closing before the next such claim is made to a sceptical
   audience.
...
3. **For our public-sector or mission-driven work, do we track the
   ...
   private-sector organisation applies to revenue?** If your organisation
...
metric movement with less organisational complexity diluting the
...
organisational complexity and many confounding factors, but it is also
...
metrics (features shipped, on schedule) invites exactly the scepticism this
...
sceptical finance team focused on feature velocity. Rather than claiming
...
hedged chain proved more persuasive to the sceptical finance team than an
...
value to a legislative committee sceptical of the programme's ongoing cost.
...
engineering credibility in strategic conversations: an organisation that
...
- **Level 3, Standardise:** Outcome claims are built on documented,
...
- **Level 5, Orchestrate:** Engineering has a demonstrated, trusted track
  ...
  decisions at the highest level of the organisation.
...
- Track **citizen and mission outcomes** for public-sector and
  mission-driven work with the same rigor private organisations apply to
  revenue.

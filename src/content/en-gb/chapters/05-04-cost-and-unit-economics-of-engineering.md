...
software-driven organisation, and yet it is frequently the least
...
organisations use unit economics to compare the cost-efficiency of
different products, platforms, or teams on a fair basis; government
organisations use the same discipline to demonstrate fiscal
...
with usage and directly optimisable through engineering practice), and
...
usage) as an engineering metric worth optimising deliberately, not an
...
code paths, redundant infrastructure, and poorly optimised queries all show
...
prioritisation discussion, since a debt item with a demonstrated, measurable
...
cost number is easy to report and matches how many organisations already
...
is worth the modest additional tracking effort for any organisation beyond
the smallest scale.
...
often under-scrutinised budget line spread across many teams. Invest in
...
- **Level 3, Standardise:** Unit economics with a well-chosen denominator
  are tracked consistently, with cost separated into people,
  infrastructure, and tooling components organisation-wide.
...
- **Level 5, Orchestrate:** The organisation can confidently answer

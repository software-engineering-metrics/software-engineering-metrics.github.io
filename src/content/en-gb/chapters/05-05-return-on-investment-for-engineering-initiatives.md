...
advantage this book has emphasised throughout: it survives scrutiny, and an
organisation that consistently builds defensible ROI cases earns more trust,
...
organisation treated as a strategic partner from one treated as a cost
center whose spending is tolerated rather than actively invested in.
Enterprise organisations use rigorous ROI cases to compete successfully for
capital against other business investments; government organisations use
...
organisation known for only ever producing positive ROI cases, regardless
...
protects the organisation's credibility for the next case it needs to make.
...
6. **What would it take to make our next major ROI case defensible under
   genuine, sceptical scrutiny from someone outside engineering?** Walk
...
finance stakeholder's sceptical questioning exposed that the case had not
...
**Government.** A state government's court-records digitisation programme
...
discipline's own credibility: an organisation that consistently builds
...
scepticism because they have overpromised before. The logistics company
...
alternative risks the organisation's credibility for every future case it
will need to make.
...
- **Level 3, Standardise:** ROI cases consistently use full total cost of
  ownership, documented benefit evidence, and a stated range reflecting
  genuine uncertainty, organisation-wide.
...
- **Level 5, Orchestrate:** The organisation has a demonstrated,
...
1. What is our biggest current investment case, and could it survive genuinely sceptical scrutiny today?

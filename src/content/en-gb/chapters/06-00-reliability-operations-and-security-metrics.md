...
organisations write service level agreements against the metrics chapter
6.1 introduces, with real financial penalties for missing them; government
organisations operate critical public infrastructure where a reliability or
...
- **6.2 Incident metrics: detection, response, and recovery:** Measuring
  how quickly an organisation notices, responds to, and resolves a failure,

...
strict, makes organisation-wide incident data as unreliable for comparison
...
informally treated incidents as something to minimise acknowledging quickly
...
honest picture to prioritise infrastructure investment against.
...
- **Inconsistent severity classification across teams:** makes
  organisation-wide incident data unreliable for comparison.
...
- **A postmortem process that produces insight but no completed action
  items:** wastes the organisational learning the process is meant to
  capture.
...
- **Level 2, Develop:** Some incident tracking exists, but severity
  ...
  consistently lived.
- **Level 3, Standardise:** Phase-decomposed incident metrics with
  consistent, documented severity classification are tracked
  organisation-wide, with genuinely blameless postmortem practice.

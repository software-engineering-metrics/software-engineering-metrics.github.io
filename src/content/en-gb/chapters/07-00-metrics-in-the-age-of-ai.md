...
premise faster than most organisations' metrics have caught up. When a
...
argues throughout, was never the right thing to optimise for in the first
...
organisations adopting AI coding assistants at scale need to know quickly
whether their existing metrics still mean what they think they mean;
government organisations, often moving more cautiously on AI adoption but
...
specific failure modes an organisation needs to guard against as it adopts
AI-assisted development; and chapter 7.4 generalises the lesson into a

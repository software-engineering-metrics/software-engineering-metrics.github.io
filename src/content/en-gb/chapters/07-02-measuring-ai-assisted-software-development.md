...
organisational momentum. Enterprise organisations negotiating large-scale AI
tooling contracts need genuine evidence of value to justify the
expenditure and to compare competing tools fairly; government organisations,
...
- **Different tasks and different engineers may see very different AI
  assistance value.** Avoid a single, blended organisation-wide number that
...
organisation-wide average, which can hide the fact that assistance is
...
| Task-segmented outcome measurement | Reveals where value genuinely concentrates | Requires more granular tracking and categorisation effort |
...
often impractical once a tool has been rolled out organisation-wide with
...
6. **If we had to defend our AI tooling investment to a sceptical financial
   ...
   between what your organisation currently believes about AI assistance
...
phase, before full organisation-wide rollout, is often achievable here and
...
subset of its modernisation programme teams initially relied on
...
evidence-based investment decisions: an organisation that knows precisely
...
organisation and the risk of a poorly evidenced, expensive, organisation-wide
...
- **Measuring only the generation-speed step, ignoring full cycle time:**
  ...
  productivity effect.
- **Reporting a single, blended organisation-wide number:** hides real
...
- **Level 3, Standardise:** A genuine comparison design (control group or
...
- **Level 5, Orchestrate:** The organisation has a mature, evidence-based
...
5. Could we currently defend our AI tooling investment to a sceptical financial stakeholder with evidence?

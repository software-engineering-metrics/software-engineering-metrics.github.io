...
simultaneously, faster than most organisations' existing guardrails were
designed to catch.
...
optimised, in a statistical sense, to look right whether or not it actually
is.

For large teams, this chapter's risks compound with scale in a way that
should concern enterprise and government organisations specifically:
metric inflation across dozens of teams simultaneously can produce an
organisation-wide false signal of improved productivity that takes
...
- **The speed of this shift can outpace an organisation's ability to adapt
...
sensitivity, at least until your organisation has built enough evidence
...
organisation builds real evidence through chapter 7.2's measurement
...
generally. An organisation that communicates these specific, named risks
...
| Blanket, permanent heightened scrutiny of all AI-assisted code | Maximises short-term risk reduction | Unsustainable tax on a genuinely valuable capability; ignores accumulating evidence |
...
6. **What would it look like for our organisation to discover, only after
...
detection problem is harder to catch with fewer, less specialised reviewers.
...
deserves a slightly more sceptical read than usual, specifically because it
...
deliberately in organisation-wide detection capability upgrades (mutation
...
correct to the review processes an organisation already had in place.
...
- **No detection-capability investment specifically targeted at this new
  risk profile:** leaves the organisation dependent on review methods this
...
- **Level 2, Develop:** Some awareness exists, but recalibration is ad hoc
  ...
  made.
- **Level 3, Standardise:** Recalibrated thresholds and detection methods
...
- **Level 4, Manage:** A time-bound, evidence-driven recalibration
  ...
  pipeline.
- **Level 5, Orchestrate:** The organisation has a mature, proportionate,
  ...
  value through excessive caution nor exposes the organisation to undetected
  quality dilution.

...
organising principle a metrics programme has to be built around. This is
...
has emphasised building toward from its opening chapters: escaped defect
...
forward. Enterprise organisations redesigning their engineering dashboards
...
organisations, evaluating both AI tooling and the broader technology
...
- **Outcome telemetry requires real investment**, instrumentation, patience
  for slower signal, and organisational discipline to resist the pull
...
real, ongoing engineering investment that many organisations have
...
patience for that into your organisation's expectations
...
1.6's statistical caution). An organisation used to the fast, satisfying
...
Build outcome-telemetry infrastructure as a permanent organisational
capability, not as a reaction specific to whichever AI tool your
organisation happens to be using this year. This principle, and the
...
| Approach | Pros | Cons |
| --- | --- | --- |
| Output-metric-dominant dashboard | Fast, cheap feedback; familiar to most organisations | Now actively unreliable given generative AI's effect on output cost |
...
| Full, deliberate rebalancing toward outcome telemetry | Addresses the shift directly and completely | Requires the most significant organisational and investment change |
...
1. **What share of our current metrics infrastructure and dashboard
   ...
   metrics?** Calculate this ratio honestly; most organisations, assessed
...
3. **Has our organisation built genuine patience for outcome telemetry's
...
6. **What would it look like for our organisation to fully commit to this
   ...
   your organisation's actual roadmap for responding to this shift.

## Sector lens

**Startup.** Building outcome telemetry early, before output metrics have
had a chance to become deeply entrenched organisational habit, is
...
significant organisational change at this scale, likely requiring
...
increasingly vulnerable to exactly the scepticism chapter 5.3 described,
...
your organisation ahead of, rather than behind, this shift.
...
previously sceptical board member as a meaningfully more trustworthy basis
...
scepticism, adopted this chapter's principle explicitly as its founding
...
work for a large organisation, weighed against the durable, long-term risk
...
- **Building outcome-telemetry investment as a reaction to a specific
  ...
  organisation exposed to the next technology shift in the same way.
- **Failing to build organisational patience for outcome telemetry's
...
- **Presenting this shift to stakeholders as merely a response to AI
  tooling rather than as the fulfilment of this book's founding
...
- **Level 3, Standardise:** A deliberate audit and rebalancing toward
  outcome telemetry has been conducted, with genuinely obsolete output
  metrics retired, organisation-wide.
- **Level 4, Manage:** Outcome-telemetry infrastructure is treated as a
  first-class, ongoing engineering investment, and organisational patience
  for its slower feedback is actively cultivated and protected.
- **Level 5, Orchestrate:** The organisation's metrics programme is
...
3. Where has organisational impatience pulled us back toward faster but less trustworthy output metrics recently?
...
- Build organisational **patience for outcome telemetry's slower
...
- *Measure What Matters*, by John Doerr (outcome-oriented goal setting as
  an organising principle for a metrics programme, the model this chapter

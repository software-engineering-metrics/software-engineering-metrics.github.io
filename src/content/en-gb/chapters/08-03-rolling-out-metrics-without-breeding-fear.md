...
An organisation can get every technical detail right, honest visualisation,
...
organisational-behaviour research this book has cited throughout: people
who fear a metric will be used against them, undermining
[psychological safety](https://en.wikipedia.org/wiki/Psychological_safety),
respond exactly as chapter
1.2 predicts, they optimise the number rather than the underlying reality,
because the incentive to protect themselves is immediate and personal while
the harm to organisational learning is diffuse and delayed. This is not a
...
early impressions set lasting expectations. Enterprise organisations
introducing a new, organisation-wide metrics programme risk a single
mishandled early incident, one team's metrics used punitively, poisoning
trust across the whole rollout; government organisations, often introducing
...
- **This is a sustained organisational discipline, not a one-time rollout
...
in choosing which metrics to track, how they get visualised, and what
...
An organisation's response to its first mishandling incident is
disproportionately important in shaping the whole team's or organisation's
...
| Extended diagnostic-only proving period before any evaluative use | Builds durable, evidence-based trust | Slower to realise any evaluative use case leadership may eventually want |
...
4. **Has a metric ever been misused punitively, even once, even
   informally, and how did the organisation respond?** If this has
...
5. **Do the teams being measured understand why each guardrail exists, or
   ...
   never told about directly?** Discuss whether your organisation's
...
**Enterprise.** The scale and impersonality of a large organisation make
...
**Government.** Public-sector organisations often introduce metrics
...
engineers across the organisation began informally gaming their own
...
thing" with visible scepticism long after the original programme had been
...
The total cost of ownership is primarily time and organisational patience:
...
- **Level 3, Standardise:** New metrics programmes are consistently rolled
  out with proactive communication, team involvement in design, and a
  committed diagnostic-only proving period organisation-wide.
...
- **Level 5, Orchestrate:** The organisation has a demonstrated, sustained
...
3. Has our organisation ever mishandled a metric punitively, and how did we respond?
...
- *The Tyranny of Metrics*, by Jerry Z. Muller (organisational and cultural
...
- *Accelerate: The Science of Lean Software and DevOps*, by Nicole Forsgren,
  Jez Humble, and Gene Kim (the organisational-culture research underlying

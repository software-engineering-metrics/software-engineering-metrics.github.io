...
3. **Have we been averaging our strengths and weaknesses into a more
   ...
   organisation has previously talked about its own metrics maturity.
...
6. **How would our self-assessment compare to an honest external review by
   someone outside our organisation?** This question tests whether your
...
organisation has grown significantly.
...
- **Level 3, Standardise:** A structured, honest, minimum-based
...
- *The Fifth Discipline: The Art and Practice of the Learning
  Organization*, by Peter M. Senge (systems-level organisational

...
**CVSS (Common Vulnerability Scoring System).** A standardised scale for
...
organised around feedback loops, cognitive load, and flow state. See
chapter 3.7.
...
an incentivised metric improves, designed to catch gaming. See chapter 1.2.
...
value an organisation delivers, sitting at the top of a metric tree. See
chapter 1.3.
...
utilisation drive wait time. See chapter 2.7.
...
**Utilisation.** The proportion of a resource's available capacity that is
busy, calculated as arrival rate divided by service rate. Wait time grows
sharply, not gradually, as utilisation approaches full capacity. See
chapter 2.7.

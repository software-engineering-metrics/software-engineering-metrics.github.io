...
- [ ] The metric is classified as diagnostic or evaluative, in writing
      (chapter 1.1)
- [ ] If incentivised, a guardrail metric is defined at the same time
      (chapter 1.2)
...
- [ ] The dashboard has one named, specific audience and decision
      (chapter 8.1)
- [ ] Every incentivised metric appears on the same view as its guardrail
      (chapters 1.2, 8.1)
...
- [ ] The postmortem investigates the system, not the individual
      (chapter 6.2)
- [ ] Severity was classified against documented, standardised criteria
      (chapter 6.2)

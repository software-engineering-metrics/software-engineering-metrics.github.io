...
The primary audience is the people who choose what an organisation measures:
...
2. **Outcomes over output over activity.** Weight every metric set toward
   ...
   or how busy it was.
3. **Every incentivised metric needs a guardrail.** Pair speed with quality,
   throughput with stability, and never chase one number in isolation.
4. **Measure systems, not people.** A metric that individualises blame breaks
...
sequence the work. The goal is not a wall of charts. It is an organisation

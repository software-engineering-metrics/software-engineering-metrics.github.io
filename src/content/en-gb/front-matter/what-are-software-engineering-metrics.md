...
and within a quarter the team is optimising the number instead of the outcome
...
organise delivery and flow metrics more broadly, because DORA measures
...
Beyond these two frameworks, teams track localised metrics grouped by domain:
...
their organisation tracks what it tracks, and how to push back when a metric
is being misused.

## How to read it

Start here, then read the [introduction](introduction.md) for how the book
is organised, or jump straight to the [table of contents](table-of-contents.md).

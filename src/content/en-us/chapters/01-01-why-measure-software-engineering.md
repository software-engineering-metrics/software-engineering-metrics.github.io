...
something real. Software work produces one-of-a-kind artifacts under
...
teams that skip measurement do not avoid making judgments about their own
performance. They just make those judgments on vibes, anecdote, and
...
**diagnosis versus judgment**. Too few metrics and you develop blind spots
...
6. **Where has measurement become a substitute for judgment, and where has
   judgment become a substitute for measurement?** Both failure modes are
...
modernization program. The team's existing metrics were entirely internal
...
- **Level 5, Orchestrate:** Measurement is a living capability: the
  ...
  proxies still track reality, and treats the metrics program itself as
...
5. If our metrics program disappeared tomorrow, what decisions would get worse?
...
- The total cost of a metrics program is real; weigh it explicitly against
...
- *Thinking, Fast and Slow*, by Daniel Kahneman (the cognitive biases that
  make unaided judgment an unreliable substitute for measurement).
- Google's DevOps Research and Assessment (DORA) program, [dora.dev](https://dora.dev/) (the

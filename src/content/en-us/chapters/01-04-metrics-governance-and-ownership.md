...
program survive contact with organizational scale. A single team can keep
...
- **Retirement is as important as adoption.** A healthy metrics program
...
- **A metrics program that only ever adds, never retires:** produces
...
- **Level 5, Orchestrate:** Governance is proportional to consequence,
  automated where possible (a metrics catalog that flags undocumented or

...
You do not need a statistics degree to run a metrics program well, but you
...
as a cause. This chapter is the minimum statistical judgment this book
...
causation is not optional rigor, it is what separates a metrics program
...
one purely as a statistical artifact, a phenomenon called **regression to

...
2. **Do we have a written, agreed definition for what counts as a feature
   ...
   depend on whoever happens to be labeling the ticket?** An informal,
...
deprioritized in favor of visible citizen-facing features, had shrunk to
...
2. Do we have a written definition for each of the four flow item types, or does classification depend on who is labeling the work?

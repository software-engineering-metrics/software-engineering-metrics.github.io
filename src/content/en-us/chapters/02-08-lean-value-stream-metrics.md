...
multi-team pipelines and government programs with multiple approval
...
6. **Is our organization already running a Lean or Six Sigma program
...
program in operations, manufacturing-adjacent divisions, or shared
...
- **Treating classical Lean metrics as obsolete once a software-specific
  ...
  organization.
- **Ignoring an existing Lean Six Sigma program elsewhere in the
...
- **Level 5, Orchestrate:** The organization has connected its software
  delivery metrics to an existing Lean or Six Sigma program elsewhere in
...
3. Does our organization already run a Lean or Six Sigma program we have never connected engineering metrics to?

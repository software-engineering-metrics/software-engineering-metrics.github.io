...
program, a multi-year research effort, later published as the book
...
evidence, that a modernization program measurably improved delivery
...
2. **Do all the teams we compare using DORA metrics share the same
   ...
   produce unfair judgments about relative performance.
...
**Government.** DORA metrics still give a modernization program a
...
program instrumented all four DORA metrics consistently across forty
...
program's next-year priorities.
...
4. If a competitor published its DORA numbers, would ours compare favorably, and would that comparison actually tell us who is delivering more real value?
...
- Google Cloud. DevOps Research and Assessment program.

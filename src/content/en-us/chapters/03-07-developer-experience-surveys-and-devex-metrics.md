...
### Design questions for clarity and avoid leading or double-barreled
phrasing
...
you with our tooling and documentation?" is a double-barreled question that
...
biggest determinant of whether a DevEx survey program stays useful over
...
clearly-labeled deep-dive surveys for specific topics that need more
...
1. **Have we ever piloted a new survey question with a small group before
   ...
   double-barreled questions end up corrupting a full dataset before
...
5. **Are any of our current survey questions leading or double-barreled,
...
a double-barreled question that conflated two very different concerns. When
...
The return on a well-designed DevEx survey program is trustworthy,
...
more than any tooling cost, is what determines whether a survey program
...
- **Double-barreled or leading questions:** conflate distinct concerns or
...
- **Level 5, Orchestrate:** The organization has a mature, trusted,
  multi-year survey program with consistently high response rates,

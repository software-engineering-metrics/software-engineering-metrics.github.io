...
faring. This part turns to the artifact itself: the code, and what a metric
...
analysis, static analysis with human judgment, and technical debt with
...
- **4.4 Static analysis and code smell metrics:** Automated code-quality
  signals, their real value, and their limits against human judgment.
...
tests actually verify that unit's behavior; chapter 4.3 zooms out to find

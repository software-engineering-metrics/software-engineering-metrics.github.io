...
The central tension is **automation versus judgment**. A fully automated
...
candidates for review, and reserving the actual judgment, is this
...
4. **Do we use complexity metrics to triage review effort, or as a hard
   automated gate with no human judgment involved?** Discuss whether your
...
(chapter 4.4), and the real investment is the human judgment time to
...
- **Using complexity metrics to individually evaluate engineers:** invites
  gaming and misapplies a metric meant for triage, not judgment.
...
- **Ignoring trend and outliers in favor of a flat, codebase-wide

...
regression, and resists the temptation to treat the tool's judgment as a
...
**Government.** A defense agency's software supply-chain security policy
...
coverage. The defense agency example above shows the cost of getting this
...
determines whether a static analysis program provides genuine, trusted
...
- **Level 5, Orchestrate:** Static analysis findings, complexity data, and
  ...
  improvements traced to the program.
...
- *Refactoring: Improving the Design of Existing Code*, by Martin Fowler
  (the code smell catalog that much static analysis tooling draws on).

...
damage to a program's credibility with its funding body.
...
**Government.** A state government's court-records digitization program
...
- U.S. Office of Management and Budget Circular A-94, guidance on
  cost-benefit analysis for federal programs (public-sector ROI
  discipline).

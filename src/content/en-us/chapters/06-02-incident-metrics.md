...
delay acknowledgment to avoid being "on the clock," or classify a serious
...
- **Blameless culture is a prerequisite for trustworthy incident data**, not
  an optional addition; fear of blame corrupts reporting, acknowledgment
  speed, and severity classification alike.
- **Detection, acknowledgment, and resolution are distinct phases with
...
someone noticing), acknowledgment time (from notification to someone
...
acknowledgment points to an on-call process or escalation problem, and slow
...
Protect this discipline actively: leadership modeling non-punitive
...
| Approach | Pros | Cons |
| --- | --- | --- |
| Blended, single incident-response-time metric | Simple to report | Hides which specific phase, detection, acknowledgment, resolution, is the actual problem |
...
under-report, delay acknowledgment, or misclassify severity once they fear
personal consequence. Resolve the tension in favor of blameless practice
...
1. **Do we decompose incident response time into detection, acknowledgment,
...
leadership modeling of blameless response, since cultural drift toward
...
acknowledgment times that leadership initially attributed to inadequate
...
honest incident acknowledgment rather than only praising fast resolution,
produced a measurable improvement in both detection and acknowledgment
...
**Government.** A public transit agency's operations center had
...
alternative, an incident metrics program that produces confidently wrong
data because fear has corrupted every input into it.

## Anti-patterns and pitfalls

- **Blame-oriented incident review:** corrupts reporting honesty,
  acknowledgment speed, and severity classification for every future
  incident.
- **Tracking only a blended response-time number:** hides which specific
  phase, detection, acknowledgment, resolution, is actually the problem.
...
2. What is the phase breakdown, detection, acknowledgment, resolution, of our slowest recent incident?
...
- **Blameless postmortem culture is a prerequisite** for trustworthy
  incident data; fear of blame corrupts reporting, acknowledgment speed,
  and classification alike.
- Decompose response time into **detection, acknowledgment, and

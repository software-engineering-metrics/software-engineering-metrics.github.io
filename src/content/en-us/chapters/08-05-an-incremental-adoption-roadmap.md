...
program introduced overnight is exactly the kind of change that provokes
...
chapter 8.3 in favor of jumping straight to sophisticated, comprehensive
...
metrics program rollout with realistic milestones; government
...
- **Foundations first, always.** Governance (chapter 1.4), outcome
  ...
  cannot be skipped in favor of jumping straight to sophisticated metrics.
...
infrastructure chapter 7.4 argues should ultimately be your program's
...
once every phase has technically been touched. A metrics program is a
...
but fundamentally weaker program. Resolve the tension by committing to
...
2. **Did we skip Phase 1's governance foundation in favor of moving
...
5. **Are Phase 4 and Phase 5 running in appropriate parallel for us, or is
   one being neglected in favor of the other?** Discuss whether your
...
6. **Have we established the ongoing, recurring maturity assessment
   ...
   ongoing phase risks treating the metrics program as a finished
...
multi-year program with realistic milestones, and use each phase's
...
explicitly as its metrics program's structuring framework, completing
...
informal internal advocates for the program's expansion, having
experienced firsthand that the diagnostic-only commitment was genuinely
honored throughout their pilot quarter.
...
comprehensive upfront request for the agency's entire metrics program
scope had previously been rejected as too large and insufficiently
justified by demonstrated results.

## Business case: motivations, ROI, and TCO

The return on a phased, foundation-first roadmap is a metrics program
...
poorly governed program that a faster rollout risks producing. The
...
- **Rigidly following this chapter's default sequencing regardless of your
  ...
  applied mechanically without judgment.
...
- *Leading Change*, by John P. Kotter (organizational change management
  principles applicable to a phased metrics program rollout).
...
- U.S. Government Accountability Office (GAO) guidance on performance
  ...
  public-sector program funding practice.

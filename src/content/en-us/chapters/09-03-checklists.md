...
## Metrics program rollout checklist
...
- [ ] The people being measured were involved in metric selection
      (chapter 8.3)
- [ ] The program starts in diagnostic-only mode, with a committed
...
- [ ] Severity was classified against documented, standardized criteria
      (chapter 6.2)
- [ ] Detection, acknowledgment, and resolution times are recorded
...
## Metrics program audit checklist (annual)

...
distort behavior, damage trust, and reward exactly the wrong things.
...
Research and Assessment program) measure system throughput and stability:
...
teams, and program and product managers building a metrics dashboard or
scorecard for the first time, or repairing one that has started to distort
behavior. The secondary audience is any engineer who wants to understand why
